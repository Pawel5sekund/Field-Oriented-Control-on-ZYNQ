...
HD_PWD='D:/ebit_z7010-master/ip_repo/LED_controller/LED_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_controller_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_controller_v1_0.tcl
