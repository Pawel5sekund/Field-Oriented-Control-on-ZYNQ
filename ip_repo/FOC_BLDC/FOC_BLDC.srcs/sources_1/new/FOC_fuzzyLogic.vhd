    ...
    begin
        ...
        case operationSelector is
            ...
            when 2 => --take only 6 most signifficant bits from error value and let it be the one of address of 2-dimmensional table
                BRAM_error1Result_0(5 downto 0) := signed(std_logic_vector(error1Result(0 downto -5)));
                BRAM_error1Result_1(5 downto 0) := signed(std_logic_vector(error1Result(0 downto -5))) + 1;
                BRAM_error2Result_0(5 downto 0) := signed(std_logic_vector(error2Result(0 downto -5)));
                BRAM_error2Result_1(5 downto 0) := signed(std_logic_vector(error2Result(0 downto -5))) + 1;
            ...
            when 11 =>
                A_reg(8) <= std_logic_vector(sfixed(resize(vecToSfixed(P_reg(4), -34), 0, -17)));
                D_reg(8) <= std_logic_vector(sfixed(resize(vecToSfixed(P_reg(5), -34), 0, -17)));
                B_reg(8) <= std_logic_vector(to_signed(1, 18));

                A_reg(9) <= std_logic_vector(sfixed(resize(vecToSfixed(P_reg(6), -34), 0, -17)));
                D_reg(9) <= std_logic_vector(sfixed(resize(vecToSfixed(P_reg(7), -34), 0, -17)));
                B_reg(9) <= std_logic_vector(to_signed(1, 18));

                vec_result_subSum1 := std_logic_vector(resize(vecToSfixed(P_reg(8), -17), 0, -17));
                vec_result_subSum2 := std_logic_vector(resize(vecToSfixed(P_reg(9), -17), 0, -17));
            ...
            when 12 =>
                Kout_result := resize(vecToSfixed(vec_Kout_result, -17), Kout_result'left, Kout_result'right);
