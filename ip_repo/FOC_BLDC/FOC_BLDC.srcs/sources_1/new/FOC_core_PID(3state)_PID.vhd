...
end entity FOC_core_xx;

architecture behavioral of FOC_core_xx is
...
begin
    ...
    ILA_main : ILA_FOC_core
        port map (
            ...
            probe6  => std_logic_vector(positional_reading),
...
--            );
    ...
    PID_currentSetpoint : component PID
--        generic map (
        --sampling_time => 0.000000064,  --64ns
--            )
        port map (
