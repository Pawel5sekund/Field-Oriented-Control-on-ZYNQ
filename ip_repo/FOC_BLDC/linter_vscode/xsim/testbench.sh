...
#
# Generated by Vivado on Thu Jul 07 19:19:52 CEST 2022
...
# Script info
echo -e "testbench.sh - Script generated by export_simulation (Vivado v2022.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_2 -L xil_defaultlib -L blk_mem_gen_v8_4_5 -L FOC_lib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot testbench xil_defaultlib.testbench xil_defaultlib.glbl -log elaborate.log
}
