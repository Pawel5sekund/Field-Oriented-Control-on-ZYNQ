...
HD_PWD='/home/pawel5sekund/VivadoProjects/EBAZ4205/ip_repo/FOC_BLDC/FOC_BLDC.runs/MULTIPLY_DSP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MULTIPLY_DSP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MULTIPLY_DSP.tcl
