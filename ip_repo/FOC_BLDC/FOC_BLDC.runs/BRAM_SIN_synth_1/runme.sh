...
HD_PWD='/mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ip_repo/FOC_BLDC/FOC_BLDC.runs/BRAM_SIN_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_SIN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_SIN.tcl
