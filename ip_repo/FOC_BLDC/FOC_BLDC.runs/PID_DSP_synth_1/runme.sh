...
HD_PWD='/mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ip_repo/FOC_BLDC/FOC_BLDC.runs/PID_DSP_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PID_DSP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PID_DSP.tcl
