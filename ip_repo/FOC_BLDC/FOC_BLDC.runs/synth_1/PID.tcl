...
namespace eval ::optrace {
  variable script "/mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ip_repo/FOC_BLDC/FOC_BLDC.runs/synth_1/PID.tcl"
...
synth_design -top PID -part xc7z010clg400-1
...
write_checkpoint -force -noxdef PID.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file PID_utilization_synth.rpt -pb PID_utilization_synth.pb"
