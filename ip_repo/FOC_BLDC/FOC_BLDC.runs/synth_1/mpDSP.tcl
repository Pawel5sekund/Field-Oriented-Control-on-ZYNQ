...
namespace eval ::optrace {
  variable script "/mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ip_repo/FOC_BLDC/FOC_BLDC.runs/synth_1/mpDSP.tcl"
...
read_vhdl -library xil_defaultlib /mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ip_repo/FOC_BLDC/FOC_BLDC.srcs/sources_1/new/mpDSP.vhd
...
synth_design -top mpDSP -part xc7z010clg400-1
...
write_checkpoint -force -noxdef mpDSP.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file mpDSP_utilization_synth.rpt -pb mpDSP_utilization_synth.pb"
