...
namespace eval ::optrace {
  variable script "/mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ip_repo/FOC_BLDC/FOC_BLDC.runs/synth_1/FOC_fuzzyLogic.tcl"
...
read_vhdl -library FOC_lib /mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ip_repo/FOC_BLDC/FOC_BLDC.srcs/sources_1/new/FOC_fuzzyLogic.vhd
...
synth_design -top FOC_fuzzyLogic -part xc7z010clg400-1
...
write_checkpoint -force -noxdef FOC_fuzzyLogic.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file FOC_fuzzyLogic_utilization_synth.rpt -pb FOC_fuzzyLogic_utilization_synth.pb"
