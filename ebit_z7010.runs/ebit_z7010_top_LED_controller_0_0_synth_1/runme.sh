...
EAStep vivado -log ebit_z7010_top_LED_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebit_z7010_top_LED_controller_0_0.tcl
