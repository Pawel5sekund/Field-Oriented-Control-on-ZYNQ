...
HD_PWD='/mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ebit_z7010.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebit_z7010_top_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebit_z7010_top_wrapper.tcl
