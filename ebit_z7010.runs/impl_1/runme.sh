...
HD_PWD='/mnt/d/Xilinx/Projects/Vivado/Field-Oriented-Control-on-ZYNQ/ebit_z7010.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ebit_z7010_top_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ebit_z7010_top_wrapper.tcl -notrace
