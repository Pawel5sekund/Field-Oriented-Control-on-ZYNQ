...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_2 -L xil_defaultlib -L secureip -L xpm --snapshot PID_DSP xil_defaultlib.PID_DSP -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim PID_DSP -key {Behavioral:sim_1:Functional:PID_DSP} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb PID_DSP.wdb xsim.dir)
