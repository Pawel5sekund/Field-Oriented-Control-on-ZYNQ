...
entity FOC_torqueVectorGenerator is
    generic(
        ...
        positionScaler          : sfixed (0 downto -17) := resize(to_sfixed(1.0, 0, -17), 0, -17)  
        );
    port (
        CLK               : in  std_logic;
...
begin
    ...
    begin
        ...
        case operationIndex is
            ...
            when 0 =>
                vec0Position := signed(P_reg(1)(47) & P_reg(1)(33 downto 17)) + to_signed(1024, 18);  --extracting data, where (17 downto 0) is 18 bits of fractional, 47 is bit-sign and we are only interested in 17 bits of integer value
