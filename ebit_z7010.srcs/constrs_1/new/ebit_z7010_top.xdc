...
# Dual-color LED
set_property IOSTANDARD LVCMOS33 [get_ports {LED_RED_OUT_0}]
set_property IOSTANDARD LVCMOS33 [get_ports {LED_GREEN_OUT_0}]

set_property PACKAGE_PIN W13 [get_ports {LED_GREEN_OUT_0}]
set_property PACKAGE_PIN W14 [get_ports {LED_RED_OUT_0}]

set_property DRIVE 12 [get_ports {LED_RED_OUT_0}]
set_property DRIVE 12 [get_ports {LED_GREEN_OUT_0}]
